...
Keep responses concise but meaningful (2-3 paragraphs max unless asked for more detail).`;
    ...
    // Call Gemini 3 Flash Preview API with Google Search grounding
    ...
    if (!response.ok) {
      ...
      // Fallback to gemini-2.5-flash if 3 Flash fails
